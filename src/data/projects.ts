...
export const PROJECTS: Project[] = [
...

  {
    ...
    gallery: [
      { src: "/mugas-dashboard.png", alt: "MUGAS Admin Dashboard", caption: "Administrative interface for content management" },
      { src: "/mugas-research.png", alt: "Research Section", caption: "Research projects and publications showcase" },
      { src: "/mugas-events.png", alt: "Events Page", caption: "Event registration and community activities" },
      { src: "/mugas-team.png", alt: "Team Section", caption: "Member profiles and leadership showcase" },
    ],
    extraLinks: [
      // {
      //   label: "GitHub Repository",
      //   href: "https://github.com/username/mugas-platform",
      // },
      {
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "https://picsum.photos/seed/ecoscrap-mobile/1200/750", alt: "Mobile View", caption: "Responsive design on mobile devices" },
    ],
    extraLinks: [
      // {
      //   label: "GitHub Repository",
      //   href: "https://github.com/yourusername/ecoscrap",
      // },
      {
